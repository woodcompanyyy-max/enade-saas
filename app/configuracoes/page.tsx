...
import { Settings, User, Bell, Shield, Database, Trash2, RefreshCcw, BarChart2 } from "lucide-react";
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Recalcula Nota ENADE, Participação e IDD de todos os cursos com base nos dados importados. <strong>Não apaga nada.</strong>
              </p>
            </div>
          </div>
          <RecalculateButton />
